                                ...
                                <div class="col-md-12">
                                    <form action="/insurance/{{$insurance->id}}/update" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="reminder_phones" type="text" class="form-control" id="inputReminderPhones" value="{{$insurance->reminder_phones}}" placeholder="Contoh: 081234567890, 089876543210">
