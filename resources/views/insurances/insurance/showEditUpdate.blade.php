                            ...
                            <div class="panel-heading">
                                <div class="col-md-12" style="margin-bottom: 10px;">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/insurance/{{$insuranceId->id}}">Asuransi Update</a></li>
                                ...
                                <div class="col-md-12">
                                    <form action="/insurance/{{$insurance->id}}/updateInsuranceUpdate" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input name="insurance_id" type="hidden" class="form-control" value="{{$insurance->insurance_id}}" readonly>
                                        </div>
                                        <div class="form-group">
