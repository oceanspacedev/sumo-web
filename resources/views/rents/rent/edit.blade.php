                            ...
                            <div class="panel-heading">
                                <div class="col-md-12" style="margin-bottom: 20px;">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/rent/{{$rent->id}}">Perjanjian Sewa Update</a></li>
                                ...
                                <div class="col-md-12">
                                    <form action="/rent/{{$rent->id}}/update" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="reminder_phones" type="text" class="form-control" id="inputReminderPhones" value="{{$rent->reminder_phones}}" placeholder="Contoh: 081234567890, 089876543210">
